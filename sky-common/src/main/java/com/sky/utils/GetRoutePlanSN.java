...
@Component
public class GetRoutePlanSN {

    public static String AK = "klfgzHXfhBv4tGv7IWmFYyeZMMIinHnt";

    public static String SK = "eOlcdGrCRiFqY9ISw4oUcpWqOZ3g2Qvr";
    ...
    public String caculateSn(String origin, String destination) throws UnsupportedEncodingException,
        ...
        GetRoutePlanSN snCal = new GetRoutePlanSN();
